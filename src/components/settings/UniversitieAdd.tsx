...
import UniversitieEdit from "./UniversitieEdit";

const UniversitieAdd = () => {
  ...
  const addCountry = useUniversitieAdd();
  ...
  return (
    <>
      ...
      <hr />
      {universities?.map((item, k) => (
        <UniversitieEdit university={item} key={k} />
      ))}
    </>
  );
};

export default UniversitieAdd;
